  ...
  object RichEditAlert: TRichEdit
    ...
    Lines.Strings = (
      ...
      'surveillance (18/20)'
        ...
        ' XXXXXXXXX est en dessous du seuil '
      'de surveillance (18/20)'
      ''
        ...
        '2010-06-08 | Les champions de la Flamme : la quantit'#233' de l'#39'objet' +
        ' XXXXXXXXX a chang'#233' (12 -> 17) (+'
      '5)'
      ''
      
        '2010-06-08 | Misugi (ventes) : l'#39'objet XXXXXXX sera automatiquem' +
        'ent vendu au marchand dans 3 '
      'jours/heures/minutes (Fyros)'
